...
const translations = {
  zh: {
    ...
    'copySuccess': '复制成功',
    'downloadAllSuccess': '所有图片下载完成',
    'exportFailed': '导出失败。',
    'crossOriginTip': '如果内容包含外链图片，请确认图片允许跨域访问，或改用本地/同源图片。',
  ...
  en: {
    ...
    'downloadAllSuccess': 'All images downloaded',
    'exportFailed': 'Export failed.',
    'crossOriginTip': 'If the content contains remote images, make sure they allow cross-origin access or use local/same-origin images.',
